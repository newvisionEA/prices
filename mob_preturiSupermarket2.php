...
and s2.commerciant_id = c2.id
		...
		<tr
			...
			<td><?php echo $spaces.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' ?><a href="mob_detaliiProdus.php?id=<?php echo $pid?>"><?php print(htmlspecialchars($pname.' '.$bname.' '.$qty.' '.$um)); ?></a></td>
			<td>
			...
			<td>
				...
				?>	
				<A href="mob_preturiSupermarket2.php?sid=<?php echo $minstore_id?>"><IMG src="images/<?php echo $minstore_img; ?>" width = "50" title="<?php echo $minstore_name ?>"/></A> 
